      ...
      <>
        <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-2">
          <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
            {/* filters buttons  */}
            <div className="bg-gray-50 dark:bg-gray-900 flex items-center my-4">
            ...
            <div
              id="dropdownSort1"
              className={` ${
                areFiltersOpen ? "" : "hidden"
              } z-50  w-full divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700 my-4 py-2`}
              data-popper-placement="bottom"
            >
              <div className="flex flex-row items-center justify-content-center p-1">
                <h1 className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                  Categories:{" "}
                </h1>
                {categories?.map((c) => (
                  <div key={c._id} className="flex items-center inline ml-3">
                    <input
                  ...
                  <div className="pt-6">
                    ...
                    <div className="mt-4 flex items-center justify-between gap-4">
                      ...
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4  focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      >
                        <svg
